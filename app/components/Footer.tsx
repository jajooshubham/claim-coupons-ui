...
export default function Footer() {
	return (
		<footer className="p-4 md:p-8 lg:p-10 relative -z-10 bg-lime-700 text-white">
			<div className="mx-auto max-w-screen-xl text-center">
				...
				<p className="m-auto w-1/2 secondary-text py-5 ">
				...
				<div className="flex m-auto justify-between">
					<span className="text-sm secondary-text text-center secondary-text">
						© 2024{" "}
